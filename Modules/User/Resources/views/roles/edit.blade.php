        ...
        <div class="flex flex-wrap ">
            <div class="md:w-full pr-4 pl-4">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    @method('patch')
                    <div class="mb-4">
                        <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600">Update Role <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                        <div class="flex-auto p-6">
                            <div class="mb-4">
                                ...
                                <input class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" type="text" name="name" required value="{{ $role->name }}">
                            </div>
