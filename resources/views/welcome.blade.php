            ...
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s"
                        ...
                        <h1
                            ...
                            Aplikasi wirausaha lengkap kelola bisnis jadi maju
                        </h1>
                        <p
                            class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed">
                            Satu aplikasi banyak fungsi, satu harga untuk semua kebutuhan wirausaha.
                        </p>
                        ...
                        <div class="wow fadeInUp text-center" data-wow-delay=".3s"
                            ...
                            <h2 class="font-medium text-gray-200">Telah digunakan oleh:</h2>
                            <div class="flex justify-center p-4 gap-4">
                                <img src="https://majoo.id/assets/uploads/home/footer-ico/grabfood-new.png"
                                    alt="image grabfood"
                                    class="w-full max-w-[50px] max-h-[50px] opacity-70 transition duration-300 ease-in-out hover:opacity-100">
                                <img src="https://majoo.id/assets/uploads/home/footer-ico/tokopedia-new.png"
                                    alt="image tokopedia"
                                    class="w-full max-w-[50px] max-h-[50px] opacity-70 transition duration-300 ease-in-out hover:opacity-100">
                                <img src="https://majoo.id/assets/uploads/home/footer-ico/shopee-new.png"
                                    alt="image shopee"
                                    class="w-full max-w-[50px] max-h-[50px] opacity-70 transition duration-300 ease-in-out hover:opacity-100">
                                <img src="https://majoo.id/assets/uploads/home/footer-ico/bukalapak-new.png"
                                    alt="image bukalapak"
                                    class="w-full max-w-[50px] max-h-[50px] opacity-70 transition duration-300 ease-in-out hover:opacity-100">
                                <img src="https://majoo.id/assets/uploads/home/footer-ico/toko-online-new.png"
                                    alt="image custom toko online"
                                    class="w-full max-w-[150px] max-h-[50px] opacity-70 transition duration-300 ease-in-out hover:opacity-100">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s"
                        ...
                        <div class="mt-16">
                            <img src="{{ asset('images/dashboard-pos.png') }}" alt="hero"
                ...
                <div class="w-full px-4">
                    <div class="mb-12 max-w-[620px] lg:mb-20">
                        ...
                        <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
                            Layanan lengkap bisnis tumbuh berkembang
                        </h2>
                        <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                            Maksimalkan keuntungan dengan dukungan layanan bisnis tersedia kapanpun dibutuhkan.
                        </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s"
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            Pembayaran digital mudah lengkap
                        </h4>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s"
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            Belanja supplies harga terbaik
                        </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            Lorem Ipsum is simply dummy text of the printing and industry.
                        </p>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".25s"
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            Support 24 jam teknisi di 60 kota
                        </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            Lorem Ipsum is simply dummy text of the printing and industry.
                        </p>
                        ...
                        <div class="items-center justify-between overflow-hidden border lg:flex">
                            ...
                            <div class="text-center">
                                <div class="relative z-10 inline-block">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/about/about-image.svg"
                                        alt="image" class="mx-auto lg:ml-auto">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-5 sm:p-8"
                        ...
                        <button class="faq-btn flex w-full items-center text-left">
                            <div
                                ...
                                <svg width="17" height="10" viewBox="0 0 17 10" class="icon fill-white w-6 h-6">
                                    <path
            ...
            <div class="flex flex-wrap">
                    ...
                    <div class="ud-single-testimonial wow fadeInUp mb-12 bg-white p-8 shadow-testimonial"
                        ...
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                <img src="https://play-tailwind.tailgrids.com/assets/images/testimonials/author-01.png"
                                    alt="author">
                            </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="ud-single-testimonial wow fadeInUp mb-12 bg-white p-8 shadow-testimonial"
                        ...
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                <img src="https://play-tailwind.tailgrids.com/assets/images/testimonials/author-02.png"
                                    alt="author">
                            </div>
                            <div class="ud-testimonial-meta">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="ud-single-testimonial wow fadeInUp mb-12 bg-white p-8 shadow-testimonial"
                        ...
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                                <img src="https://play-tailwind.tailgrids.com/assets/images/testimonials/author-03.png"
                                    alt="author">
                            </div>
                            <div class="ud-testimonial-meta">
                        ...
                        <div class="ud-brands-logo flex flex-wrap items-center">
                            <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/brands/tailgrids.svg"
                                        alt="tailgrids" class="grayscale duration-300 hover:filter-none">
                                </a>
                            </div>
                            <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                <a href="https://ayroui.com" target="_blank" rel="nofollow noopner">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/brands/ayroui.svg"
                                        alt="ayroui" class="grayscale duration-300 hover:filter-none">
                                </a>
                            </div>
                            <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                <a href="https://uideck.com" target="_blank" rel="nofollow noopner">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/brands/uideck.svg"
                                        alt="uideck" class="grayscale duration-300 hover:filter-none">
                                </a>
                            </div>
                            <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                <a href="https://graygrids.com" target="_blank" rel="nofollow noopner">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/brands/graygrids.svg"
                                        alt="graygrids" class="grayscale duration-300 hover:filter-none">
                                </a>
                            </div>
                            <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                                <a href="https://lineicons.com" target="_blank" rel="nofollow noopner">
                                    <img src="https://play-tailwind.tailgrids.com/assets/images/brands/lineicons.svg"
                                        alt="lineicons" class="grayscale duration-300 hover:filter-none">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp mb-10" data-wow-delay=".1s"
                        ...
                        <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                            <img src="https://play-tailwind.tailgrids.com/assets/images/team/team-01.png" alt="image"
                                class="w-full rounded-full">
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="1.29337" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 1.29337 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 12.6747 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 24.0575 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 35.4379 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="46.8197" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 46.8197 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="68.807" cy="80.7066" r="1.29337" transform="rotate(-90 68.807 80.7066)"
                                        fill="#3056D3"></circle>
                                    <circle cx="57.9443" cy="80.7066" r="1.29337"
                                        transform="rotate(-90 57.9443 80.7066)" fill="#3056D3"></circle>
                                    <circle cx="1.29337" cy="69.3249" r="1.29337"
                                        transform="rotate(-90 1.29337 69.3249)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="69.3249" r="1.29337"
                                        transform="rotate(-90 12.6747 69.3249)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="69.3249" r="1.29337"
                                        transform="rotate(-90 24.0575 69.3249)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="69.3249" r="1.29337"
                                        transform="rotate(-90 35.4379 69.3249)" fill="#3056D3"></circle>
                                    ...
                                    <circle cx="1.29337" cy="57.9433" r="1.29337"
                                        transform="rotate(-90 1.29337 57.9433)" fill="#3056D3"></circle>
                                    <circle cx="1.29337" cy="24.0568" r="1.29337"
                                        transform="rotate(-90 1.29337 24.0568)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="57.9433" r="1.29337"
                                        transform="rotate(-90 12.6747 57.9433)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="24.0568" r="1.29337"
                                        transform="rotate(-90 12.6747 24.0568)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="57.9433" r="1.29337"
                                        transform="rotate(-90 24.0575 57.9433)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="24.0568" r="1.29337"
                                        transform="rotate(-90 24.0575 24.0568)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="57.9433" r="1.29337"
                                        transform="rotate(-90 35.4379 57.9433)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="24.0568" r="1.29337"
                                        transform="rotate(-90 35.4379 24.0568)" fill="#3056D3"></circle>
                                    <circle cx="46.8197" cy="57.9431" r="1.29337"
                                        transform="rotate(-90 46.8197 57.9431)" fill="#3056D3"></circle>
                                    <circle cx="46.8197" cy="24.0567" r="1.29337"
                                        transform="rotate(-90 46.8197 24.0567)" fill="#3056D3"></circle>
                                    ...
                                    <circle cx="57.9433" cy="57.9431" r="1.29337"
                                        transform="rotate(-90 57.9433 57.9431)" fill="#3056D3"></circle>
                                    <circle cx="57.9443" cy="24.0567" r="1.29337"
                                        transform="rotate(-90 57.9443 24.0567)" fill="#3056D3"></circle>
                                    <circle cx="1.29337" cy="46.5615" r="1.29337"
                                        transform="rotate(-90 1.29337 46.5615)" fill="#3056D3"></circle>
                                    <circle cx="1.29337" cy="12.6751" r="1.29337"
                                        transform="rotate(-90 1.29337 12.6751)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="46.5615" r="1.29337"
                                        transform="rotate(-90 12.6747 46.5615)" fill="#3056D3"></circle>
                                    <circle cx="12.6747" cy="12.6751" r="1.29337"
                                        transform="rotate(-90 12.6747 12.6751)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="46.5615" r="1.29337"
                                        transform="rotate(-90 24.0575 46.5615)" fill="#3056D3"></circle>
                                    <circle cx="24.0575" cy="12.6751" r="1.29337"
                                        transform="rotate(-90 24.0575 12.6751)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="46.5615" r="1.29337"
                                        transform="rotate(-90 35.4379 46.5615)" fill="#3056D3"></circle>
                                    <circle cx="35.4379" cy="12.6751" r="1.29337"
                                        transform="rotate(-90 35.4379 12.6751)" fill="#3056D3"></circle>
                                    <circle cx="46.8197" cy="46.5615" r="1.29337"
                                        transform="rotate(-90 46.8197 46.5615)" fill="#3056D3"></circle>
                                    <circle cx="46.8197" cy="12.6751" r="1.29337"
                                        transform="rotate(-90 46.8197 12.6751)" fill="#3056D3"></circle>
                                    ...
                                    <circle cx="57.9443" cy="1.29354" r="1.29337"
                                        transform="rotate(-90 57.9443 1.29354)" fill="#3056D3"></circle>
                                </svg>
                            </span>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp mb-10" data-wow-delay=".15s"
                        style="visibility: visible; animation-delay: 0.15s;">
                        <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                            <img src="https://play-tailwind.tailgrids.com/assets/images/team/team-02.png" alt="image"
                                class="w-full rounded-full">
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp mb-10" data-wow-delay=".2s"
                        style="visibility: visible; animation-delay: 0.2s;">
                        <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                            <img src="https://play-tailwind.tailgrids.com/assets/images/team/team-03.png" alt="image"
                                class="w-full rounded-full">
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
