<nav class="ud-header absolute top-0 left-0 z-40 flex w-full items-center bg-transparent">
    <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
            <div class="w-60 max-w-full px-4">
                <a href="{{ url('/') }}" class="navbar-logo block w-full py-5">
                    <img src="{{ asset('images/xezar-logo.svg') }}" alt="logo" class="header-logo w-full">
                </a>
            </div>
            <div class="flex w-full items-center justify-between px-4">
                    ...
                    <nav id="navbarCollapse"
                        ...
                        <ul class="blcok lg:flex">
                            ...
                            <li class="submenu-item group relative">
                                ...
                                <div
                                    class="submenu relative top-full left-0 w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                    <a href="about.html"
                ...
                <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
                    ...
                    <a href="{{  route('register') }}"
                        class="signUpBtn rounded-lg bg-white bg-opacity-20 py-3 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-gray-700">
                        Daftar
                    </a>
                </div>
            </div>
